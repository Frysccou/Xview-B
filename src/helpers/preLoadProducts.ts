...
const productsToPreLoad: IProduct[] = [
	...
	},
	{
		...
		price: 28.5,
		description:
			"Naruto Shippuden continúa la historia de Naruto Uzumaki, ahora un adolescente, mientras regresa a la Aldea Oculta de la Hoja después de un entrenamiento de dos años y medio con Jiraiya. La historia se centra en la búsqueda de Naruto y sus amigos para salvar a Sasuke Uchiha de las garras de Orochimaru y la organización Akatsuki, que busca capturar a las bestias con colas para sus propios fines. La serie explora temas de amistad, pérdida, venganza y el significado de la paz, mientras Naruto lucha por proteger a sus seres queridos y alcanzar su sueño de convertirse en Hokage.",
		image: "https://image.tmdb.org/t/p/original/3IdPC9SO1lyrxlMu3lCnH6aVbKh.jpg",
		categoryId: 2,
		stock: 15,
		genres: ["Action", "Adventure", "Martial Arts", "Fantasy", "Shounen"],
